...
class InspectionReportResourceIT {
        ...
        restInspectionReportMockMvc
            .perform(
                post(ENTITY_API_URL)
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(inspectionReportDTO))
            )
    ...
    void putExistingInspectionReport() throws Exception {
        ...
        restInspectionReportMockMvc
            .perform(
                put(ENTITY_API_URL_ID, inspectionReportDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(inspectionReportDTO))
            )
    ...
    void patchNonExistingInspectionReport() throws Exception {
        ...
        restInspectionReportMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, inspectionReportDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(inspectionReportDTO))
            )
