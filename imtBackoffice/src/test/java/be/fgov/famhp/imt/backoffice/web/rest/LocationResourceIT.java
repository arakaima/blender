...
class LocationResourceIT {
    ...
    private static final String DEFAULT_ACTIVE_REQUEST = "AAAAAAAAAA";
    private static final String UPDATED_ACTIVE_REQUEST = "BBBBBBBBBB";

    private static final Boolean DEFAULT_HEAD_QUARTERS = false;
    private static final Boolean UPDATED_HEAD_QUARTERS = true;
    ...
    public static Location createEntity() {
        Location location = new Location().activeRequest(DEFAULT_ACTIVE_REQUEST).headQuarters(DEFAULT_HEAD_QUARTERS).status(DEFAULT_STATUS);
        return location;
    }
    ...
    public static Location createUpdatedEntity() {
        Location location = new Location().activeRequest(UPDATED_ACTIVE_REQUEST).headQuarters(UPDATED_HEAD_QUARTERS).status(UPDATED_STATUS);
        return location;
    }
    ...
    void createLocation() throws Exception {
        ...
        assertThat(testLocation.getActiveRequest()).isEqualTo(DEFAULT_ACTIVE_REQUEST);
        assertThat(testLocation.getHeadQuarters()).isEqualTo(DEFAULT_HEAD_QUARTERS);
    ...
    void getAllLocations() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.[*].activeRequest").value(hasItem(DEFAULT_ACTIVE_REQUEST)))
            .andExpect(jsonPath("$.[*].headQuarters").value(hasItem(DEFAULT_HEAD_QUARTERS.booleanValue())))
    ...
    void getLocation() throws Exception {
        ...
        restLocationMockMvc
            ...
            .andExpect(jsonPath("$.activeRequest").value(DEFAULT_ACTIVE_REQUEST))
            .andExpect(jsonPath("$.headQuarters").value(DEFAULT_HEAD_QUARTERS.booleanValue()))
    ...
    void putExistingLocation() throws Exception {
        ...
        updatedLocation.activeRequest(UPDATED_ACTIVE_REQUEST).headQuarters(UPDATED_HEAD_QUARTERS).status(UPDATED_STATUS);
        ...
        Location testLocation = locationList.get(locationList.size() - 1);
        assertThat(testLocation.getActiveRequest()).isEqualTo(UPDATED_ACTIVE_REQUEST);
        assertThat(testLocation.getHeadQuarters()).isEqualTo(UPDATED_HEAD_QUARTERS);
    ...
    void partialUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.activeRequest(UPDATED_ACTIVE_REQUEST).status(UPDATED_STATUS);
    ...
    void fullUpdateLocationWithPatch() throws Exception {
        ...
        partialUpdatedLocation.activeRequest(UPDATED_ACTIVE_REQUEST).headQuarters(UPDATED_HEAD_QUARTERS).status(UPDATED_STATUS);
