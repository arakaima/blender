...
class RiskAssessmentResourceIT {
        ...
        restRiskAssessmentMockMvc
            .perform(
                post(ENTITY_API_URL)
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(riskAssessmentDTO))
            )
    ...
    void putExistingRiskAssessment() throws Exception {
        ...
        restRiskAssessmentMockMvc
            .perform(
                put(ENTITY_API_URL_ID, riskAssessmentDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(riskAssessmentDTO))
            )
    ...
    void patchNonExistingRiskAssessment() throws Exception {
        ...
        restRiskAssessmentMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, riskAssessmentDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(riskAssessmentDTO))
            )
