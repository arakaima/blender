...
public class SiteResource {
     ...
     */
    @PutMapping("/sites/{id}")
    public ResponseEntity<Site> updateSite(@PathVariable(value = "id", required = false) final String id, @RequestBody Site site)
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, site.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Site> partialUpdateSite(@PathVariable(value = "id", required = false) final String id, @RequestBody Site site)
        throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, site.getId()));
    }
