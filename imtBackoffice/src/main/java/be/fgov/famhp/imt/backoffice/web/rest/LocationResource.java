...
/**
 * REST controller for managing {@link be.fgov.famhp.imt.backoffice.domain.Location}.
 */
@RestController
@RequestMapping("/api")
public class LocationResource {
    ...
    private static final String ENTITY_NAME = "imtBackofficeLocation";
    ...
    public ResponseEntity<Location> updateLocation(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, location.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Location> partialUpdateLocation(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, location.getId())
        );
    }
