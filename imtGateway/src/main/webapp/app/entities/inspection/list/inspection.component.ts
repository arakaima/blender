...
import { EntityArrayResponseType, InspectionService } from '../service/inspection.service';
...
export class InspectionComponent implements OnInit {
  ...
  trackId = (_index: number, item: IInspection): string => this.inspectionService.getInspectionIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.inspections = this.refineData(dataFromBody);
  }

  protected refineData(data: IInspection[]): IInspection[] {
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.inspectionService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
