...
describe('Inspection Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'inspection', component: InspectionComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inspections?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
