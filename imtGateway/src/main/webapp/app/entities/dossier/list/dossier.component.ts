...
import { EntityArrayResponseType, DossierService } from '../service/dossier.service';
...
export class DossierComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDossier): string => this.dossierService.getDossierIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.dossiers = this.refineData(dataFromBody);
  }
