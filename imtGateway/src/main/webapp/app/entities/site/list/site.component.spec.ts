...
describe('Site Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'site', component: SiteComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sites?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });
