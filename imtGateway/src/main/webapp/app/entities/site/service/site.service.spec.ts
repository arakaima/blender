...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../site.test-samples';

import { SiteService } from './site.service';

const requireRestSample: ISite = {
  ...
  describe('Service methods', () => {
    ...
    describe('addSiteToCollectionIfMissing', () => {
      it('should add a Site to an empty array', () => {
        const site: ISite = sampleWithRequiredData;
      ...
      it("should add a Site to an array that doesn't contain it", () => {
        const site: ISite = sampleWithRequiredData;
        const siteCollection: ISite[] = [sampleWithPartialData];
        expectedResult = service.addSiteToCollectionIfMissing(siteCollection, site);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(site);
      });
      ...
      it('should add only unique Site to an array', () => {
        const siteArray: ISite[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const siteCollection: ISite[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const site: ISite = sampleWithRequiredData;
        const site2: ISite = sampleWithPartialData;
    ...
    describe('compareSite', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareSite(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareSite(entity1, entity2);
        const compareResult2 = service.compareSite(entity2, entity1);
