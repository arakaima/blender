...
/**
 * REST controller for managing {@link be.fgov.famhp.imt.gateway.domain.InspectionReport}.
 */
@RestController
@RequestMapping("/api")
public class InspectionReportResource {
    ...
    private static final String ENTITY_NAME = "inspectionReport";
    ...
    public Mono<ResponseEntity<InspectionReportDTO>> createInspectionReport(@RequestBody InspectionReportDTO inspectionReportDTO)
    ...
    public Mono<ResponseEntity<InspectionReportDTO>> updateInspectionReport(
    ...
    public Mono<ResponseEntity<InspectionReportDTO>> partialUpdateInspectionReport(
        @PathVariable(value = "id", required = false) final String id,
        @RequestBody InspectionReportDTO inspectionReportDTO
    ) throws URISyntaxException {
        ...
        return inspectionReportRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<InspectionReportDTO> result = inspectionReportService.partialUpdate(inspectionReportDTO);
    ...
    public Mono<List<InspectionReportDTO>> getAllInspectionReports() {
        log.debug("REST request to get all InspectionReports");
        return inspectionReportService.findAll().collectList();
    }

    /**
     * {@code GET  /inspection-reports} : get all the inspectionReports as a stream.
     * @return the {@link Flux} of inspectionReports.
     */
    @GetMapping(value = "/inspection-reports", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<InspectionReportDTO> getAllInspectionReportsAsStream() {
        log.debug("REST request to get all InspectionReports as a stream");
    ...
    public Mono<ResponseEntity<InspectionReportDTO>> getInspectionReport(@PathVariable String id) {
        log.debug("REST request to get InspectionReport : {}", id);
        Mono<InspectionReportDTO> inspectionReportDTO = inspectionReportService.findOne(id);
    ...
    public Mono<ResponseEntity<Void>> deleteInspectionReport(@PathVariable String id) {
