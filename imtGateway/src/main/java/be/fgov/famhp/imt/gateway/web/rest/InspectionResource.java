...
/**
 * REST controller for managing {@link be.fgov.famhp.imt.gateway.domain.Inspection}.
 */
@RestController
@RequestMapping("/api")
public class InspectionResource {
    ...
    public Mono<ResponseEntity<InspectionDTO>> createInspection(@RequestBody InspectionDTO inspectionDTO) throws URISyntaxException {
    ...
    public Mono<ResponseEntity<InspectionDTO>> updateInspection(
    ...
    public Mono<ResponseEntity<InspectionDTO>> partialUpdateInspection(
        @PathVariable(value = "id", required = false) final String id,
        @RequestBody InspectionDTO inspectionDTO
    ) throws URISyntaxException {
        ...
        return inspectionRepository
            ...
            .flatMap(exists -> {
                ...
                Mono<InspectionDTO> result = inspectionService.partialUpdate(inspectionDTO);
    ...
    public Mono<List<InspectionDTO>> getAllInspections() {
        log.debug("REST request to get all Inspections");
        return inspectionService.findAll().collectList();
    }

    /**
     * {@code GET  /inspections} : get all the inspections as a stream.
     * @return the {@link Flux} of inspections.
     */
    @GetMapping(value = "/inspections", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<InspectionDTO> getAllInspectionsAsStream() {
        log.debug("REST request to get all Inspections as a stream");
    ...
    public Mono<ResponseEntity<InspectionDTO>> getInspection(@PathVariable String id) {
        log.debug("REST request to get Inspection : {}", id);
        Mono<InspectionDTO> inspectionDTO = inspectionService.findOne(id);
    ...
    public Mono<ResponseEntity<Void>> deleteInspection(@PathVariable String id) {
