...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("be.fgov.famhp.imt.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("be.fgov.famhp.imt.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
