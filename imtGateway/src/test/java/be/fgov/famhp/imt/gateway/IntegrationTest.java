...
import be.fgov.famhp.imt.gateway.ImtGatewayApp;
import be.fgov.famhp.imt.gateway.config.AsyncSyncConfiguration;
import be.fgov.famhp.imt.gateway.config.EmbeddedMongo;
...
@SpringBootTest(classes = { ImtGatewayApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
